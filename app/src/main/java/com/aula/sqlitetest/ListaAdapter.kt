...
class ListaAdapter (nameList: List<Dato>, private var ctx: Context, private val callbacks: (Int) -> Unit): RecyclerView.Adapter<ListaAdapter.ViewHolder>() {

    private var nameList: List<Dato> = ArrayList<Dato>()
    init {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.btn.setOnClickListener {
            ...
            databaseHandler.deleteDato(name.id)
            callbacks(position)
        }
    }
